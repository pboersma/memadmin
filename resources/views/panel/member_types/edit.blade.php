    ...
    <div class="container py-4">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body px-4 py-4">
                <form action="{{ route('member_types.update', $member_type->id) }}" method="POST" class="row g-3">
                    @csrf
                    @method('PUT')

                    <div class="col-md-12">
                        <label for="description" class="form-label fw-semibold">Omschrijving</label>
                        <input type="text" id="description" name="description" value="{{ old('description', $member_type->description) }}"
